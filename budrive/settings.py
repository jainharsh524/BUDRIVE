"""
Django settings for budrive project.
...
AUTH_USER_MODEL = 'budrive.CustomUser'
...
INSTALLED_APPS = [
    ...
    'budrive.apps.BudriveConfig',   # include burive app
...
WSGI_APPLICATION = 'budrive.wsgi.application'
